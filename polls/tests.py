...
class QuestionModelTests(TestCase):
    ...
    def test_published_after_end_time(self):
        """
        Check that does the vote is currently allowed after publication date
        """
        pub = timezone.now() - datetime.timedelta(hours=23, minutes=59, seconds=59)
    ...
    def test_published_before_pub_time(self):
        """
        Check that does the vote is currently allowed before publication date
        """
        pub = timezone.now() + datetime.timedelta(hours=23, minutes=59, seconds=59)
    ...
    def test_published_between_pub_and_end_time(self):
        """
        Check that does the vote is currently allowed between publication and end date
        """
        pub = timezone.now() - datetime.timedelta(hours=23, minutes=59, seconds=59)
        end = pub + abs(datetime.timedelta(days=2))
        recent_question = Question(pub_date=pub, end_date=end)
    ...
    def test_between_pub_and_end_time(self):
        """
        Test that the user can vote or not between pub time and end time.
        """
        pub = timezone.now() - datetime.timedelta(hours=23, minutes=59, seconds=59)
        end = pub + abs(datetime.timedelta(days=2))
        recent_question = Question(pub_date=pub, end_date=end)
    ...
    def test_vote_before_pub_time(self):
        ...
        """
        pub = timezone.now() + datetime.timedelta(hours=5, minutes=5, seconds=5)
